...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <div className="absolute top-46 left-16 z-10 xs:left-0 xs:top-24 md:left-4 md:top-36 flex flex-row items-start gap-5 pl-10">
        <div className="flex flex-col justify-center items-center mt-5">
          <div className ="w-5 h-5 rounded-full bg-[#29a638]" />
          <div className="w-1 sm:h-20 h-40 green-gradient rounded-full" />
        </div>
        <div>
          <h1 className={`${styles.heroHeadText} text-white xs:text-[24px]` }>Hi, I'm 
             <span className="text-[#32e847]"> Shaun</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 xs:text-[14px] text-white-100`}>
